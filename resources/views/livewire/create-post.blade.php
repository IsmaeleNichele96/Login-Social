...
<div class="col-12 col-lg-6 mt-5 d-flex justify-content-start formComponent rounded-3">
    ...
    <form wire:submit.prevent='store' class="d-flex justify-content-start">
        <div class="d-flex justify-content-start flex-column ">
            ...
            <div class="row">
                <div class="col-12 d-flex justify-content-center mt-3">
                    <button wire:loading.attr="disabled"  type="submit" class="btn btn-success ms-5">Crea Post</button>
                </div>
            </div>
        </div>
    </form>
